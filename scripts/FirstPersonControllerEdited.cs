...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonControllerEdited : MonoBehaviour
    {
        ...
        private int playerID;//Rewired: player input id
        [SerializeField] private Player player;//Rewired: new reference for input
        ...
        private void Start()
        {
            //Keyboard layout (0 = wasd / 1 = zqsd)
            playerID = scriptableVars.keyboardLayout;
            player = ReInput.players.GetPlayer(playerID);//Rewired: new input from Rewired
